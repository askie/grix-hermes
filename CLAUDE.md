...
| Skill | Role |
|---|---|
| `grix-admin` | Low-level WS admin for remote agents, API keys, categories, assignment, and status |
...
grix-hermes 是 Hermes 技能包。统一出站 E2E 测试覆盖有 AI 模型交互的适配器（Claude、Gemini、Qwen、Codex、OpenClaw）。
